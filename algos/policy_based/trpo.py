...
class TRPOAgent(Agent):
    def __init__(self,
        ...
        self.episodes_per_roll=episodes_per_roll
        self.gamma=gamma
    ...
    def learn(self):
        ...
        while True:
            ...
            def fisher_vector_product(p):
                ...
                return self.session.run(self.fvp, feed) + self.cg_damping * p # WHAT 'config["cg_damping"]'
            def loss(th):
                self.sff(th)
...
class TRPO(RLAlgorithm):
    ...
    def train(self):
        ...
        trpo = TRPOAgent(
            ...
            episodes_per_roll=self.episodes_per_roll,
            gamma=self.gamma,
